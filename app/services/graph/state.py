...
class SkillGraphState(BaseModel):
    ...
    vendor: str | None = Field(None, description="LLM vendor override")
    ...
    human_feedback: dict[str, Any] | None = Field(None, description="Human reviewer feedback")

    # Dynamic routing
    next_action: str | None = Field(None, description="Next action to take")
