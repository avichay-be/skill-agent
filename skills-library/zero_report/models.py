...
class TenderDetail(BaseModel):
    ...
    tender_type: Optional[str] = Field(
        None, alias="tenderType", description='Type of tender (e.g. מכרז רמ"י)'
    )
    ...
    winning_company: Optional[str] = Field(
        None, alias="winningCompany", description="Winning company name"
    )
...
class ProjectInfo(BaseModel):
    ...
    company_id: Optional[str] = Field(
        None, alias="companyId", description="ח.פ. registration number"
    )
    contractor_license: Optional[str] = Field(
        None, alias="contractorLicense", description="Contractor license number"
    )
    contractor_classification: Optional[str] = Field(
        None, alias="contractorClassification", description="e.g. ג/5 בלתי מוגבל"
    )
    location: Optional[str] = Field(None, description="Neighborhood, city")
    block: Optional[Union[int, str]] = Field(None, description="גוש")
    parcels: Optional[Union[str, List[Union[str, int, ParcelDetail]]]] = Field(
        None, description="חלקות"
    )
    ...
    reduced_price_units: Optional[int] = Field(
        None, alias="reducedPriceUnits", description="מחיר מופחת/מטרה/למשתכן units"
    )
    free_market_units: Optional[int] = Field(
        None, alias="freeMarketUnits", description="שוק חופשי units"
    )
    ...
    report_status: Optional[str] = Field(
        None, alias="reportStatus", description="Report status in Hebrew"
    )
    appraiser: Optional[str] = Field(None, description="Appraiser firm/person")
    tender: Optional[Union[str, TenderDetail]] = Field(
        None, description="Tender info (string or structured)"
    )
    tender_area: Optional[Union[int, str]] = Field(
        None, alias="tenderArea", description="Precinct code"
    )
    original_tender_units: Optional[int] = Field(
        None, alias="originalTenderUnits", description="Units in original tender"
    )
...
class FinancialSummary(BaseModel):
    ...
    reduced_price_revenue: Optional[int] = Field(
        None, alias="reducedPriceRevenue", description="Revenue from reduced price units"
    )
    free_market_revenue: Optional[int] = Field(
        None, alias="freeMarketRevenue", description="Revenue from free market units"
    )
    revenue_after_hedge: Optional[int] = Field(
        None, alias="revenueAfterHedge", description="Revenue after hedge/גידור"
    )
    hedge_amount: Optional[int] = Field(
        None, alias="hedgeAmount", description="Hedge/reserve amount"
    )
    ...
    profit_margin_revenue: Optional[float] = Field(
        None, alias="profitMarginRevenue", description="Profit as % of revenue"
    )
    profit_margin_costs: Optional[float] = Field(
        None, alias="profitMarginCosts", description="Profit as % of costs"
    )
    equity_required: Optional[int] = Field(
        None, alias="equityRequired", description="Equity required ILS"
    )
    equity_percent: Optional[float] = Field(
        None, alias="equityPercent", description="Equity as % of expenses"
    )
    loan_amount: Optional[int] = Field(None, alias="loanAmount", description="Loan amount ILS")
    max_exposure: Optional[int] = Field(
        None, alias="maxExposure", description="Max bank exposure ILS"
    )
    max_exposure_month: Optional[int] = Field(
        None, alias="maxExposureMonth", description="Month of max exposure"
    )
    interest_rate: Optional[float] = Field(
        None, alias="interestRate", description="Annual interest rate %"
    )
    ...
    avg_unit_price: Optional[int] = Field(
        None, alias="avgUnitPrice", description="Average unit price"
    )
...
class RevenueTrack(BaseModel):
    ...
    track_name: Optional[str] = Field(
        None, alias="trackName", description="Track name (מחיר מופחת/שוק חופשי/שלב א')"
    )
    ...
    avg_price_per_unit: Optional[int] = Field(
        None, alias="avgPricePerUnit", description="Average price per unit"
    )
...
class UnitMixEntry(BaseModel):
    ...
    equivalent_area: Optional[float] = Field(
        None, alias="equivalentArea", description="Weighted area for pricing"
    )
    total_revenue: Optional[int] = Field(
        None, alias="totalRevenue", description="Total revenue for this type"
    )
    avg_price_per_unit: Optional[int] = Field(
        None, alias="avgPricePerUnit", description="Average price per unit"
    )
...
class ExpenseCategory(BaseModel):
    ...
    items: Optional[Dict[str, Any]] = Field(
        default_factory=dict, description="Line items (key: amount or {description, amount, ...})"
    )
...
class ExpenseBreakdown(BaseModel):
    ...
    land_and_development: Optional[ExpenseCategory] = Field(
        None, alias="landAndDevelopment", description="Land and development costs"
    )
    construction: Optional[ExpenseCategory] = Field(None, description="Construction costs")
    additional_costs: Optional[ExpenseCategory] = Field(
        None, alias="additionalCosts", description="Additional costs"
    )
    total_expenses: int = Field(
        ..., alias="totalExpenses", description="Must equal sum of 3 subtotals"
    )
    avg_cost_per_unit: Optional[int] = Field(
        None, alias="avgCostPerUnit", description="Average cost per unit"
    )
    avg_cost_per_sqm: Optional[int] = Field(
        None, alias="avgCostPerSqm", description="Average cost per sqm"
    )
...
class BuiltAreas(BaseModel):
    ...
    main_area: Optional[AreaDetail] = Field(
        None, alias="mainArea", description="Main residential area"
    )
    residential_only: Optional[AreaDetail] = Field(
        None, alias="residentialOnly", description="Residential-only area"
    )
...
class FloorMixEntry(BaseModel):
    ...
    residential_area: Optional[float] = Field(
        None, alias="residentialArea", description="Residential area sqm"
    )
...
class BreakEvenAnalysis(BaseModel):
    ...
    units_required: Optional[int] = Field(
        None, alias="unitsRequired", description="Units needed to break even"
    )
    percent_required: Optional[float] = Field(
        None, alias="percentRequired", description="% of total units"
    )
    ...
    discount_at_break_even: Optional[float] = Field(
        None, alias="discountAtBreakEven", description="Max discount %"
    )
...
class BaseCosts(BaseModel):
    ...
    construction_variable: Optional[int] = Field(
        None, alias="constructionVariable", description="Variable construction cost"
    )
...
class SensitivityAnalysis(BaseModel):
    ...
    revenue_change_levels: Optional[List[str]] = Field(
        default_factory=list, alias="revenueChangeLevels"
    )
    ...
    profit_matrix: Optional[List[SensitivityRow]] = Field(
        default_factory=list, alias="profitMatrix"
    )
    profit_margin_matrix: Optional[List[SensitivityMarginRow]] = Field(
        default_factory=list, alias="profitMarginMatrix"
    )
...
class Timeline(BaseModel):
    ...
    construction_duration: Optional[Union[int, str]] = Field(
        None, alias="constructionDuration", description="Total months"
    )
    construction_duration_months: Optional[str] = Field(
        None, alias="constructionDurationMonths", description="Hebrew description"
    )
...
class BuildingRights(BaseModel):
    ...
    service_area_above_ground: Optional[Union[str, float]] = Field(
        None, alias="serviceAreaAboveGround"
    )
    service_area_below_ground: Optional[Union[str, float]] = Field(
        None, alias="serviceAreaBelowGround"
    )
...
class MarketComparables(BaseModel):
    ...
    average_by_rooms: Optional[Dict[str, Union[int, RoomAverage]]] = Field(
        default_factory=dict, alias="averageByRooms"
    )
...
class ReportMetadata(BaseModel):
    ...
    bank_contacts: Optional[List[Union[str, BankContact]]] = Field(
        default_factory=list, alias="bankContacts"
    )
    ...
    dwelling_types: Optional[List[Union[str, Dict[str, Any]]]] = Field(
        default_factory=list, alias="dwellingTypes"
    )
...
class ValidationNotes(BaseModel):
    ...
    revenue_minus_expenses_equals_profit: Optional[bool] = Field(
        None, alias="revenueMinusExpensesEqualsProfit"
    )
    ...
    revenue: Optional[int] = Field(
        None, description="Revenue used for calc (may be revenueAfterHedge)"
    )
...
class DoachEfesResult(BaseModel):
    ...
    project_info: ProjectInfo = Field(
        ..., alias="projectInfo", description="Project identification"
    )
    financial_summary: Optional[FinancialSummary] = Field(
        None, alias="financialSummary", description="Financial overview"
    )
    revenue_by_track: List[RevenueTrack] = Field(
        default_factory=list, alias="revenueByTrack", description="Revenue by track/phase"
    )
    expense_breakdown: Optional[ExpenseBreakdown] = Field(
        None, alias="expenseBreakdown", description="Three-way expense breakdown"
    )
    risks: List[Risk] = Field(default_factory=list, description="Risk assessment entries")

    # Optional sections
    free_market_unit_mix: Optional[List[UnitMixEntry]] = Field(
        default_factory=list, alias="freeMarketUnitMix"
    )
    built_areas: Optional[BuiltAreas] = Field(None, alias="builtAreas")
    unit_mix_by_floor: Optional[List[FloorMixEntry]] = Field(
        default_factory=list, alias="unitMixByFloor"
    )
