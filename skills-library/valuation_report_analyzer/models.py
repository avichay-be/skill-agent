...
class ProjectIdentification(BaseModel):
    ...
    company_number: Optional[str] = Field(
        None, alias="companyNumber", description="Company registration number"
    )
    ...
    tender_number: Optional[str] = Field(
        None, alias="tenderNumber", description="Tender number if applicable"
    )
...
class ProjectScale(BaseModel):
    ...
    reduced_price_units: Optional[int] = Field(
        None, alias="reducedPriceUnits", description="Units in reduced price track"
    )
    free_market_units: Optional[int] = Field(
        None, alias="freeMarketUnits", description="Units in free market track"
    )
    total_buildings: Optional[int] = Field(
        None, alias="totalBuildings", description="Number of buildings"
    )
...
class ReportInfo(BaseModel):
    ...
    appraiser_company: Optional[str] = Field(
        None, alias="appraiserCompany", description="Appraiser company (Hebrew)"
    )
    report_date: Optional[str] = Field(
        None, alias="reportDate", description="Report date DD/MM/YYYY"
    )
...
class RevenueData(BaseModel):
    ...
    original_term: Optional[str] = Field(
        None, alias="originalTerm", description="Original Hebrew term"
    )
    excludes_vat: Optional[bool] = Field(
        None, alias="excludesVAT", description="Whether amount excludes VAT"
    )
...
class ProfitData(BaseModel):
    ...
    margin_to_revenue: Optional[float] = Field(
        None, alias="marginToRevenue", description="Profit margin to revenue %"
    )
    margin_to_expenses: Optional[float] = Field(
        None, alias="marginToExpenses", description="Profit margin to expenses %"
    )
...
class PerUnitData(BaseModel):
    ...
    average_revenue: Optional[int] = Field(
        None, alias="averageRevenue", description="Average revenue per unit"
    )
    reduced_price_avg: Optional[int] = Field(
        None, alias="reducedPriceAvg", description="Average for reduced price units"
    )
    free_market_avg: Optional[int] = Field(
        None, alias="freeMarketAvg", description="Average for free market units"
    )
...
class ExpenseItem(BaseModel):
    ...
    price_per_sqm: Optional[float] = Field(
        None, alias="pricePerSqm", description="Price per sqm if applicable"
    )
...
class AcquisitionCosts(BaseModel):
    ...
    total_acquisition: Optional[int] = Field(
        None, alias="totalAcquisition", description="Total acquisition costs"
    )
...
class OverallAssessment(BaseModel):
    ...
    main_concerns: List[str] = Field(
        default_factory=list, alias="mainConcerns", description="Main concerns (Hebrew)"
    )
...
class ConditionalFlags(BaseModel):
    ...
    conditional_report: bool = Field(
        False, alias="conditionalReport", description="Is this a conditional report"
    )
    permit_pending: bool = Field(
        False, alias="permitPending", description="Building permit pending"
    )
    reduced_price_approval_pending: bool = Field(
        False, alias="reducedPriceApprovalPending", description="Reduced price approval pending"
    )
    archaeological_risk: bool = Field(
        False, alias="archaeologicalRisk", description="Archaeological site risk"
    )
...
class ValuationReportResult(BaseModel):
    ...
    financial_summary: Optional[FinancialSummary] = Field(
        None, alias="financialSummary", description="Financial summary"
    )
